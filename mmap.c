...
//    DrawFace(fbfd, 0, 0, 0, 0, makepixel(235, 200, 0)) ;         /* Yellow색상을 생성 */ 
    DrawFaceMMAP(fbfd, 0, 0, 0, 0, makepixel(24, 155, 0)) ;         /* Yellow색상을 생성 */ 
	...
	DrawStart(fbfd,0,0,0,0, makepixel(100,40,60));
